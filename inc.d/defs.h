...
int _s_close(int);
void _s_exit(int);
int _s_open(const char *pathname, int flags, mode_t mode);
void *_s_memchr(const void *s, int c, size_t n);
void *_s_memcpy(void *dest, const void *src, size_t n);
void *_s_memmove(void *dest, const void *src, size_t n);
